  ...
  return (
    <div className="text-center py-10 md:py-20 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
        ...
        <Link href="/dashboard/competitors" className="card hover:shadow-lg transition-shadow cursor-pointer">
        ...
        <Link href="/dashboard/autopilot" className="card hover:shadow-lg transition-shadow cursor-pointer">
